 ...
 *
 */
declare function ActivationCard({ dismissButton, message, link, status, statusMessage, title, }: Props): import("react/jsx-runtime").JSX.Element;
declare namespace ActivationCard {
