 ...
 *
 */
declare function Popover({ accessibilityLabel, accessibilityDismissButtonLabel, anchor, children, showDismissButton, onKeyDown, id, idealDirection, forceDirection, onDismiss, positionRelativeToAnchor, disablePortal, color, role, shouldFocus, _deprecatedShowCaret, size, scrollBoundary, hideWhenReferenceHidden, __onPositioned, __overflow, }: Props): null | ReactElement;
