 ...
 */
declare function TableSortableHeaderCell({ align, children, colSpan, onSortChange, previousTotalWidth, rowSpan, scope, shouldBeSticky, shouldHaveShadow, status, sortOrder, }: Props): import("react/jsx-runtime").JSX.Element;
