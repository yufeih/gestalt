 ...
 *
 */
declare function Pog({ accessibilityLabel, active, bgColor, focusColor, dangerouslySetSvgPath, disabled, focused, hovered, icon, iconColor, padding, rounding, selected, size, }: Props): import("react/jsx-runtime").JSX.Element;
declare namespace Pog {
