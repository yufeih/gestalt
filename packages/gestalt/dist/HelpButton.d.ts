 ...
 */
declare function HelpButton({ accessibilityLabel, accessibilityPopoverLabel, idealDirection, isWithinFixedContainer, link, onClick, text, zIndex, }: Props): import("react/jsx-runtime").JSX.Element;
