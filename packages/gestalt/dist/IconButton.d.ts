...
type Props = {
     ...
     */
    bgColor?: 'transparent' | 'transparentDarkGray' | 'transparentDarkGray' | 'gray' | 'lightGray' | 'washLight' | 'white' | 'red';
    /**
 ...
 *
 */
declare const IconButtonWithForwardRef: import("react").ForwardRefExoticComponent<Omit<Props, "ref"> & import("react").RefAttributes<HTMLButtonElement>>;
