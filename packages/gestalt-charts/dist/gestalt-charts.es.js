import require$$0, { createContext, useContext, Fragment, useMemo, useState, useCallback, useEffect } from 'react';
import { XAxis, YAxis, Bar, Rectangle, Line, ReferenceArea, ResponsiveContainer, CartesianGrid, Tooltip, Legend, ComposedChart, BarChart, LineChart } from 'recharts';
import { Box, useDefaultLabel, Flex, Heading, Text, IconButton, useColorScheme, ButtonGroup, Button, useDeviceType, Table, Layer, Modal } from 'gestalt';
...
function Header({ title, readyToRender, description, onVisualPatternChange, helpButton, titleDisplay, toggleTabularDataModal, showTabularData, }) {
    ...
    return (jsxRuntime.jsx(Box, { marginBottom: 5, width: "100%", children: jsxRuntime.jsxs(Flex, { width: "100%", children: [jsxRuntime.jsx(Flex.Item, { flex: "grow", children: titleDisplay === 'hidden' ? null : (jsxRuntime.jsxs(Flex, { direction: "column", children: [jsxRuntime.jsxs(Flex, { alignItems: "center", gap: 2, children: [jsxRuntime.jsx(Heading, { color: readyToRender ? 'default' : 'inverse', size: "300", children: title }), helpButton || null] }), jsxRuntime.jsx(Text, { color: readyToRender ? 'subtle' : 'inverse', size: "100", children: description })] })) }), jsxRuntime.jsx(IconButton, { accessibilityLabel: "", bgColor: readyToRender ? undefined : 'transparent', icon: "table", iconColor: readyToRender ? 'darkGray' : 'white', name: "table", onClick: toggleTabularDataModal, selected: showTabularData, size: "xs", tooltip: { text: tabularData } }), showVisualPattern === 'disabled' ? null : (jsxRuntime.jsx(IconButton, { accessibilityLabel: "", bgColor: readyToRender ? undefined : 'transparent', icon: "accessibility", 
...
function renderAxis({ isHorizontalLayout, isHorizontalBiaxialLayout, isVerticalLayout, isTimeSeries, isVerticalBiaxialLayout, isBar, isCombo, range, tickFormatter, labelMap, tickCount, }) {
    ...
    return (jsxRuntime.jsxs(Fragment, { children: [isHorizontalLayout && (jsxRuntime.jsxs(Fragment, { children: [jsxRuntime.jsx(XAxis, { axisLine: false, dataKey: "name", 
                        ...
                        tickFormatter: isTimeSeries
                            ...
                            : (value) => (labelMap === null || labelMap === void 0 ? void 0 : labelMap[value]) || value, tickLine: false, type: isTimeSeries ? 'number' : 'category' }), jsxRuntime.jsx(YAxis, { axisLine: false, domain: Array.isArray(range) ? range : range === null || range === void 0 ? void 0 : range.yAxisLeft, orientation: isRtl ? 'right' : 'left', 
                        ...
                        tickFormatter: tickFormatter === null || tickFormatter === void 0 ? void 0 : tickFormatter.yAxisLeft, tickLine: false, yAxisId: "left" })] })), isHorizontalBiaxialLayout && (jsxRuntime.jsx(YAxis, { axisLine: false, domain: Array.isArray(range) ? range : range === null || range === void 0 ? void 0 : range.yAxisLeft, orientation: isRtl ? 'left' : 'right', 
                // @ts-expect-error - TS2322 - Type '{ readonly color: "var(--color-text-subtle)"; readonly fontSize: "var(--font-size-100)"; readonly fontFamily: "var(--font-family-default-latin)"; readonly fontWeight: "var(--font-weight-normal)"; }' is not assignable to type 'Properties<string | number, string & {}>'.
                style: FONT_STYLE_VALUES, tickCount: tickCount, 
                // @ts-expect-error - TS2322 - Type '((arg1: number, arg2: number) => string | number) | undefined' is not assignable to type '((value: any, index: number) => string) | undefined'.
                tickFormatter: tickFormatter === null || tickFormatter === void 0 ? void 0 : tickFormatter.yAxisRight, tickLine: false, yAxisId: "right" })), isVerticalLayout && (jsxRuntime.jsxs(Fragment, { children: [jsxRuntime.jsx(XAxis, { axisLine: false, 
                        ...
                        style: FONT_STYLE_VALUES, tickCount: tickCount, 
                        // @ts-expect-error - TS2322 - Type '((arg1: number, arg2: number) => string | number) | undefined' is not assignable to type '((value: any, index: number) => string) | undefined'.
                        tickFormatter: tickFormatter === null || tickFormatter === void 0 ? void 0 : tickFormatter.xAxisBottom, tickLine: false, type: "number", xAxisId: "bottom" }), jsxRuntime.jsx(YAxis, { axisLine: false, dataKey: "name", orientation: isRtl ? 'right' : 'left', 
                        // @ts-expect-error - TS2322 - Type '{ readonly fontSize: "var(--font-size-100)"; readonly fontFamily: "var(--font-family-default-latin)"; readonly fontWeight: "var(--font-weight-normal)"; }' is not assignable to type 'Properties<string | number, string & {}>'.
                        style: FONT_STYLE_CATEGORIES, tickFormatter: (value) => (labelMap === null || labelMap === void 0 ? void 0 : labelMap[value]) || value, tickLine: false, type: "category" })] })), isVerticalBiaxialLayout && (jsxRuntime.jsx(XAxis, { axisLine: false, 
                // @ts-expect-error - TS2322 - Type '[number | "auto" | "dataMin" | "dataMax" | ((arg1: number) => number), number | "auto" | "dataMin" | "dataMax" | ((arg1: number) => number)] | { xAxisBottom?: [number | "auto" | "dataMin" | "dataMax" | ((arg1: number) => number), number | ... 3 more ... | ((arg1: number) => number)] | undefined; xAxisTop?: [...] | u...' is not assignable to type 'AxisDomain | undefined'.
...
function renderElements({ elements = [], layout, stacked, hexColor, visualPatternSelected, isHorizontalLayout, isBarRounded, }) {
    ...
    return elements.map((values, index) => {
        ...
        if (isBarElement) {
            return (jsxRuntime.jsx(Bar, Object.assign({ 
                ...
                shape: (_a) => {
                    ...
                    return (jsxRuntime.jsx(Rectangle, Object.assign({}, props, { height: stacked && index !== 0 && height > 0 ? height - 2 : height, radius: (lastElementPos !== index && stacked) || !isBarRounded
                            ? squaredRadius
                            : roundedRadius })));
        ...
        if (isLineElement) {
            ...
            return (jsxRuntime.jsx(Line, Object.assign({ activeDot: false, dataKey: values.id, 
                // @ts-expect-error - TS2769 - No overload matches this call.
...
function renderReferenceAreas({ referenceAreas, }) {
    ...
    // Recharts doesn't recognize wrappers on their components, therefore, needs to be build within ChartGraph
    jsxRuntime.jsx(ReferenceArea, { isFront: true, shape: (props) => jsxRuntime.jsx(Rectangle, Object.assign({}, props, { fill: "url(#pattern-referencearea-01)" })), strokeOpacity: 0.3, x1: values.x1, x2: values.x2, y1: values.y1, y2: values.y2, yAxisId: values.yAxisId }, values.id)));
}
...
const useBuildCsvData = ({ transformedTabularData, isHorizontalLayout, }) => {
    ...
    const csvObj = useMemo(() => `${tableSeriesText},${isHorizontalLayout ? tableXAxisText : tableYAxisText},${isHorizontalLayout ? tableYAxisText : tableXAxisText}\n${transformedTabularData
...
const useTabularData = ({ data, filterId, filterOrder, labelMap, tickFormatter, isHorizontalLayout, }) => {
    const transformedTabularData = useMemo(() => data
        ...
        .flat(), [data, labelMap]);
    const sortedData = useMemo(() => transformedTabularData.sort(getCompareFn({ filterId, filterOrder })), [filterId, filterOrder, transformedTabularData]);
    const localizedData = useMemo(() => sortedData.map((item) => {
...
function TabularDataModalFooter({ title, toggleTabularDataModal, isHorizontalLayout, transformedTabularData, }) {
    ...
    return (jsxRuntime.jsx(Flex, { justifyContent: "end", children: jsxRuntime.jsxs(ButtonGroup, { children: [jsxRuntime.jsx(Button, { color: "gray", onClick: toggleTabularDataModal, text: cancelButtonText }), jsxRuntime.jsx("a", { download: `${title.toLowerCase().replace(' ', '_')}.csv`, href: encodedData, children: jsxRuntime.jsx(Button, { color: "red", iconEnd: "download", text: downloadCsvButtonText }) })] }) }));
}
...
function TabularDataModalHeading({ title, toggleTabularDataModal }) {
    ...
    return (jsxRuntime.jsxs(Flex, { direction: "column", children: [jsxRuntime.jsxs(Flex, { justifyContent: "between", children: [jsxRuntime.jsx(Heading, { accessibilityLevel: 1, size: "500", children: title }), deviceType !== 'mobile' ? (jsxRuntime.jsx(IconButton, { accessibilityLabel: accessibilityLabelDismissModal, bgColor: "white", icon: "cancel", iconColor: "darkGray", onClick: toggleTabularDataModal, size: "sm" })) : null] }), jsxRuntime.jsx(Text, { color: "subtle", size: "200", children: tabularData })] }));
}

function TabularDataModal$1({ title, isHorizontalLayout, transformedTabularData, onSortChange, sortOrder, sortCol, }) {
    const { tableSeriesText, tableXAxisText, tableYAxisText } = useDefaultLabel('ChartGraph');
    return (jsxRuntime.jsxs(Table, { accessibilityLabel: title, children: [jsxRuntime.jsx(Table.Header, { children: jsxRuntime.jsxs(Table.Row, { children: [jsxRuntime.jsx(Table.SortableHeaderCell, { onSortChange: () => onSortChange('series'), sortOrder: sortOrder, status: sortCol === 'series' ? 'active' : 'inactive', children: jsxRuntime.jsx(Text, { size: "200", weight: "bold", children: tableSeriesText }) }), jsxRuntime.jsx(Table.SortableHeaderCell, { onSortChange: () => onSortChange('x'), sortOrder: sortOrder, status: sortCol === 'x' ? 'active' : 'inactive', children: jsxRuntime.jsx(Text, { size: "200", weight: "bold", children: isHorizontalLayout ? tableXAxisText : tableYAxisText }) }), jsxRuntime.jsx(Table.SortableHeaderCell, { onSortChange: () => onSortChange('y'), sortOrder: sortOrder, status: sortCol === 'y' ? 'active' : 'inactive', children: jsxRuntime.jsx(Text, { size: "200", weight: "bold", children: isHorizontalLayout ? tableYAxisText : tableXAxisText }) })] }) }), jsxRuntime.jsx(Table.Body, { children: transformedTabularData.map(({ series, xAxis, yAxis }) => (jsxRuntime.jsxs(Table.Row, { children: [jsxRuntime.jsx(Table.Cell, { children: jsxRuntime.jsx(Text, { children: series }) }), jsxRuntime.jsx(Table.Cell, { children: jsxRuntime.jsx(Text, { size: "200", children: xAxis }) }), jsxRuntime.jsx(Table.Cell, { children: jsxRuntime.jsx(Text, { size: "200", children: yAxis }) })] }, `id-${series}-${xAxis}-${yAxis}`))) })] }));
}
...
function TabularDataModal({ title, toggleTabularDataModal, data, tickFormatter, labelMap, modalZIndex, isHorizontalLayout, }) {
    ...
    return (jsxRuntime.jsx(Layer, { zIndex: modalZIndex, children: jsxRuntime.jsx(Modal, { accessibilityModalLabel: tabularData, align: "start", footer: jsxRuntime.jsx(TabularDataModalFooter, { isHorizontalLayout: isHorizontalLayout, title: title, toggleTabularDataModal: toggleTabularDataModal, transformedTabularData: transformedTabularData }), heading: jsxRuntime.jsx(TabularDataModalHeading, { title: title, toggleTabularDataModal: toggleTabularDataModal }), onDismiss: toggleTabularDataModal, size: "sm", children: jsxRuntime.jsx(TabularDataModal$1, { isHorizontalLayout: isHorizontalLayout, onSortChange: onSortChange, sortCol: sortCol, sortOrder: sortOrder, title: title, transformedTabularData: transformedTabularData }) }) }));
}

function useCustomTooltip({ isDarkMode, renderTooltip, }) {
    return useCallback(({ active, payload, label, }) => (jsxRuntime.jsx(Box, { borderStyle: isDarkMode ? undefined : 'shadow', color: isDarkMode ? 'elevationFloating' : 'default', maxWidth: 300, padding: 4, rounding: 4, children: renderTooltip !== 'none' &&
            renderTooltip !== 'auto' &&
...
function useDefaultLegend({ isHorizontalBiaxialLayout, isVerticalBiaxialLayout, isRtl, height, labelMap, setLegendHeight, referenceAreaSummary, }) {
    return useCallback(({ payload }) => {
        const series = payload.map(({ payload: payloadData, }) => (jsxRuntime.jsxs(Flex, { gap: { row: 2, column: 0 }, children: [jsxRuntime.jsx(LegendIcon, { payloadData: Object.assign(Object.assign({}, payloadData), { isLegend: true }) }), jsxRuntime.jsx(Text, { size: "200", children: (labelMap === null || labelMap === void 0 ? void 0 : labelMap[payloadData.dataKey]) || payloadData.dataKey })] }, payloadData.dataKey)));
        const referenceAreas = (referenceAreaSummary === null || referenceAreaSummary === void 0 ? void 0 : referenceAreaSummary.map(({ label }) => (jsxRuntime.jsxs(Flex, { gap: { row: 2, column: 0 }, children: [jsxRuntime.jsx(LegendIcon, { payloadData: { referenceArea: 'default', isLegend: true } }), jsxRuntime.jsx(Text, { size: "200", children: label })] }, label)))) || [];
        const legendItemsArray = [...series, ...referenceAreas];
        if (isHorizontalBiaxialLayout) {
            return (jsxRuntime.jsx("div", { style: { direction: isRtl ? 'rtl' : 'ltr' }, children: jsxRuntime.jsx(Box, { color: "transparent", marginBottom: 6, width: "100%", children: jsxRuntime.jsx(Flex, { justifyContent: "between", children: legendItemsArray.slice(0, 2) }) }) }));
        }
        if (isVerticalBiaxialLayout) {
            return (jsxRuntime.jsx("div", { style: { direction: isRtl ? 'rtl' : 'ltr' }, children: jsxRuntime.jsx(Box, { alignContent: "end", color: "transparent", dangerouslySetInlineStyle: { __style: { top: '-15px' } }, display: "flex", height: height, position: "absolute", children: jsxRuntime.jsx(Flex, { direction: "column", justifyContent: "between", children: legendItemsArray.slice(0, 2) }) }) }));
        }
        return (jsxRuntime.jsx("div", { style: { direction: isRtl ? 'rtl' : 'ltr' }, children: jsxRuntime.jsx(Box, { ref: (ref) => {
                    if (ref)
                        setLegendHeight(ref.getBoundingClientRect().height);
                }, color: "transparent", width: "100%", children: jsxRuntime.jsx(Flex, { gap: { row: 4, column: 0 }, wrap: true, children: legendItemsArray }) }) }));
    }, [
...
function useDefaultTooltip({ isDarkMode, labelMap, isTimeSeries, isRtl, tickFormatter, }) {
    return useCallback(({ active, payload, label }) => (jsxRuntime.jsx("div", { style: { direction: isRtl ? 'rtl' : 'ltr' }, children: jsxRuntime.jsx(Box, { borderStyle: isDarkMode ? undefined : 'shadow', color: isDarkMode ? 'elevationFloating' : 'default', maxWidth: 300, padding: 2, rounding: 4, children: active && Array.isArray(payload) ? (jsxRuntime.jsxs(Flex, { direction: "column", gap: 2, children: [jsxRuntime.jsx(Flex.Item, { children: payload.map((payloadData) => (jsxRuntime.jsxs(Flex, { alignItems: "center", gap: 2, children: [jsxRuntime.jsx(LegendIcon, { payloadData: payloadData }), jsxRuntime.jsx(Flex.Item, { flex: "grow", children: jsxRuntime.jsx(Text, { size: "100", children: (labelMap === null || labelMap === void 0 ? void 0 : labelMap[payloadData.dataKey]) || payloadData.name }) }), jsxRuntime.jsx(Text, { size: "200", weight: "bold", children: payloadData.value })] }, payloadData.name))) }), jsxRuntime.jsxs(Text, { color: "subtle", size: "100", children: [isTimeSeries && typeof label === 'number' && (tickFormatter === null || tickFormatter === void 0 ? void 0 : tickFormatter.timeseries)
...
function ChartGraph({ accessibilityLabel, visualPatternSelected, data, description, initialTicks = 'auto', range = [0, 'auto'], helpButton, elements, layout: externalLayout = 'vertical', labelMap, legend = 'auto', modalZIndex, onVisualPatternChange, stacked, tickFormatter, children, titleDisplay = 'visible', title, type = 'bar', referenceAreas = [], renderTooltip = 'auto', }) {
    ...
    // HELPERS
    const toggleTabularDataModal = useCallback(() => setShowTabularDataModal((value) => !value), []);
    ...
    // SUBCOMPONENTS
    const chartElements = useMemo(() => renderElements({
        elements,
        stacked,
        hexColor,
        layout,
    ...
    const referenceAreasElements = useMemo(() => renderReferenceAreas({ referenceAreas }), [referenceAreas]);
    const axisElements = useMemo(() => renderAxis({
        isHorizontalLayout,
        isHorizontalBiaxialLayout,
        isVerticalLayout,
        isTimeSeries,
    ...
    const referenceAreaSummary = useMemo(() => referenceAreas
    ...
    return (jsxRuntime.jsxs(ChartProvider, { decal: visualPatternSelected, children: [jsxRuntime.jsxs(Box, { color: "default", direction: "column", display: "flex", padding: 4, width: isHorizontalLayout ? '100%' : undefined, children: [jsxRuntime.jsx(Header, { description: description, helpButton: helpButton, onVisualPatternChange: onVisualPatternChange, readyToRender: chartWidth > 0, showTabularData: showTabularDataModal, title: title, titleDisplay: titleDisplay, toggleTabularDataModal: toggleTabularDataModal }), children ? (jsxRuntime.jsx(Box, { marginBottom: 4, children: jsxRuntime.jsx(Flex, { gap: 2, children: children }) })) : null, jsxRuntime.jsx("div", { style: { direction: 'ltr' }, children: jsxRuntime.jsx(Box, { height: "100%", maxWidth: 960, width: "100%", children: jsxRuntime.jsx(ResponsiveContainer, { debounce: 150, height: internalHeight, minHeight: internalHeight, minWidth: "100%", onResize: (width, height) => {
                                    ...
                                    data: data, layout: isVerticalLayout ? 'vertical' : 'horizontal', margin: {
                                        ...
                                        left: 5,
                                    }, children: [patterns, jsxRuntime.jsx(CartesianGrid, { horizontal: isVerticalLayout ? false : undefined, stroke: TOKEN_COLOR_BORDER_CONTAINER, vertical: isVerticalLayout ? undefined : false }), axisElements, renderTooltip === 'none' ? (jsxRuntime.jsx(Tooltip, { content: jsxRuntime.jsx(EmptyBox, {}), isAnimationActive: false })) : (jsxRuntime.jsx(Tooltip
                                        // @ts-expect-error - TS2769 - No overload matches this call.
                                        , { 
                                            // @ts-expect-error - TS2769 - No overload matches this call.
                                            content: renderTooltip === 'auto' ? defaultTooltip : customTooltip, cursor: { fill: `rgb(0 0 0 / ${TOKEN_OPACITY_100}` }, isAnimationActive: false })), jsxRuntime.jsx(Legend, { align: legendAlign, content: legend === 'auto' || isVerticalBiaxialLayout || isHorizontalBiaxialLayout ? (defaultLegend) : (jsxRuntime.jsx(EmptyBox, {})), iconSize: 16, iconType: "square", verticalAlign: legendVerticalAlign }), referenceAreas && referenceAreasElements, chartElements] })) }) }) })] }), showTabularDataModal ? (jsxRuntime.jsx(TabularDataModal, { data: data, isHorizontalLayout: isHorizontalLayout, labelMap: labelMap, modalZIndex: modalZIndex, tickFormatter: tickFormatter, title: title, toggleTabularDataModal: toggleTabularDataModal })) : null] }));
}
ChartGraph.LegendIcon = LegendIcon;
ChartGraph.displayName = 'ChartGraph';

export { ChartGraph };
//# sourceMappingURL=gestalt-charts.es.js.map
