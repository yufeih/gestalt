 ...
 */
declare function DateField({ autoComplete, disabled, disableRange, errorMessage, helperText, id, label, labelDisplay, localeData, maxDate, minDate, mobileEnterKeyHint, name, onBlur, onChange, onClearInput, onError, onFocus, readOnly, size, value, }: Props): import("react/jsx-runtime").JSX.Element;
